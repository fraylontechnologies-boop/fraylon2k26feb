...
import { FiMail, FiLinkedin, FiChevronRight, FiGlobe, FiMapPin } from 'react-icons/fi';
        ...
        <div className="leader-profile-page">
            ...
            <nav className="profile-breadcrumbs">
                <div className="container">
                    <Link to="/">Fraylon Global</Link>
                    <FiChevronRight className="sep" />
                    <Link to="/leadership">Contacts</Link>
                    <FiChevronRight className="sep" />
                    <span className="current">{leader.name}</span>
                </div>
            </nav>

            {/* --- Elite Hero Section (PwC Style) --- */}
                ...
                <div className="container">
                    <div className="hero-layout">
                        ...
                        >
                            ...
                            <h1 className="leader-name-heading">{leader.name}</h1>
            ...
            <section className="profile-cta">
                <div className="container">
                    <div className="cta-box">
                        ...
                        <Link to="/contact" className="btn-mnc">Inquire Globally</Link>
                    </div>
                </div>
            </section>
        </div>
